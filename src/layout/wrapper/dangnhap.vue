...
import TopDangNhap from "../components/TopDangNhap.vue";
import MenuDangNhap from "../components/MenuDangNhap.vue";
import BotDangNhap from "../components/BotDangNhap.vue";
export default {
    name        :   "app",
    components  :   {
        TopDangNhap, MenuDangNhap, BotDangNhap
    }
}
</script>
<style>
