<template>
    <div class="d-flex justify-content-between">
                <h4 style="color: #e0b010">DANH SÁCH PHIM Bộ</h4>
            </div>
...
export default {
    ...
    methods: {
        ...
        locPhim() {
            axios
                .get('http://127.0.0.1:8000/api/khach-hang/phim/loc-phim-bo', { params: this.filters })
                .then(response => {
                this.listPhimBo = response.data.data;
                })
                .catch(error => {
                console.error(error);
                });
